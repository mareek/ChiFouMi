...
namespace ChiFouMi
{
    public static class OldGame
    {
        ...
        private static bool Initialize(Func<string> Input)
        {
        ...
        public static void LaunchGame(string[] args, Action<string> Output, Func<string> InputPlayer, Func<char> InputComputer)
        {
